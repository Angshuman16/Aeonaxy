...
const Subscription = () => {
  return (
    <div className='bg-blue-950  p-4 md:p-0 md:h-[24rem] w-full flex flex-col md:flex-row items-center justify-center '>
        ...
        <form>
          <div className='flex flex-col md:flex-row mb-6'>
            <div className='md:mr-2'>
              ...
              <input type="text" placeholder='First Name' className='border border-slate-200 h-10 rounded-lg placeholder:px-2 mb-2 md:mb-0'></input>
            </div>
            <div>
              <label className='font-semibold mb-2'>Last Name</label>
              <input type='text' placeholder='Last Name' className='border border-slate-200 h-10 rounded-lg placeholder:px-2'></input>
            </div>
          </div>
